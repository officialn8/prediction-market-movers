...
import { Eye, ArrowLeft, Zap, Star } from 'lucide-react'
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Markets you're tracking</p>
          </div>
        </div>
        ...
        <div className="glass rounded-2xl border border-white/5 p-12 text-center">
          ...
          <p className="text-gray-400 mb-6 max-w-md mx-auto">
            Save your favorite markets and track them all in one place. Add notes and get personalized insights.
          </p>
